...
<div class="columns"> <!-- Columns wrapper tag open -->
	...
	<div class="column is-half is-offset-one-quarter"> <!-- is half column tag open -->
		...
		<div class="card"> <!-- card tag open -->
			...
			<div class="card-content"> <!-- Card content tag open -->
				...
				<div class="field">
					...
					<div class="control">
						<textarea class="textarea is-primary" placeholder="" > uguiguyituifuyffghfbchg uyguigfuigui ugiuguigiuguug ugiu </textarea>
					</div>
				</div>
		...
		<footer class="card-footer">
			<a href="/order" class="card-footer-item is-bold has-text-black"> Checkout </a>
		</footer>
